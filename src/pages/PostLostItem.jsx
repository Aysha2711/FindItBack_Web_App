  ...
  return (
    <div className="post-lost-container">
      ...
      <p className="subtitle">
        Lost something? We're here to help! Fill in the details so others can recognize and return your item.
      </p>
      ...
      <form className="lost-form">
        ...
        <section className="form-section">
          ...
          <h6>We keep your contact information private. It will only be used if you verifies found of your lost item.</h6>
        ...
        <div className='btn'>
          <button type="submit" className="submit-btn"  onClick={() => navigate("/success-msg")}>Submit Lost Item Report</button>
        </div>
