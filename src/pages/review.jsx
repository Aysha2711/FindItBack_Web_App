    ...
    <div className="vf-wrapperr">
      ...
      <div className="vf-container">
        ...
        <div className="item-card11">
                ...
                <div className='btn'>
                  <button type="submit" className="submit-btn1"  onClick={() => navigate("/verification-lost")}>Review</button>
                </div>
        ...
        <div className="item-card11">
                ...
                <div className='btn'>
                  <button type="submit" className="submit-btn1"  onClick={() => navigate("/verification-found")}>Review</button>
                </div>
                <div className="item-details1">
